...
import com.gaia3d.converter.chemicalAccidentDataConverter.DataContainer;
import com.gaia3d.converter.chemicalAccidentDataConverter.DataLayer;
import com.gaia3d.converter.chemicalAccidentDataConverter.DataSlice;
import com.gaia3d.converter.chemicalAccidentDataConverter.PngsBinaryBlockData;
...
@Slf4j
public class ChemicalContaminationData2DConverter {
    ...
    public void ConvertData2DByDataStructureFile(String inputDataStructurePath, String inputFolderPath, String outputFolderPath) throws IOException {
        ...
        for (int i = 0; i < filesCount; i++) {
            ...
            log.info("converting txt file to png: " + txtFileName, " : " + i + "/" + filesCount);
